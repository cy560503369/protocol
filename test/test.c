...
int main(void)
{
	...
	char* a104_test = "{\"classify\":[{\"message_table\":[{\"group\":1,\"setting\":[[1024,\"SHBIOT.TEST.TEST04\"],[1025,\"SHBIOT.TEST.TEST05\"]]}],\"device_addr\":[\"1\"],\"state_table\":[[1,1,\"SHBIOT.TEST.TEST03\"]]}],\"protocol\":\"iec104\",\"port\":\"2404\",\"work_mode\":\"192.168.31.224\"}";
